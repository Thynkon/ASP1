...
class PromotionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create promotion" do
    assert_difference("Promotion.count") do
      post promotions_url, params: { promotion: { ended_at: @promotion.ended_at, name: @promotion.name, started_at: @promotion.started_at } }
    end
  ...
  test "should update promotion" do
    patch promotion_url(@promotion), params: { promotion: { ended_at: @promotion.ended_at, name: @promotion.name, started_at: @promotion.started_at } }
