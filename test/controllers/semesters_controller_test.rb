...
class SemestersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create semester" do
    assert_difference("Semester.count") do
      post semesters_url, params: { semester: { ended_at: @semester.ended_at, started_at: @semester.started_at } }
    end
  ...
  test "should update semester" do
    patch semester_url(@semester), params: { semester: { ended_at: @semester.ended_at, started_at: @semester.started_at } }
