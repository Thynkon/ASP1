...
class ExamsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create exam" do
    assert_difference("Exam.count") do
      post exams_url, params: { exam: { consideration: @exam.consideration, name: @exam.name, passed_at: @exam.passed_at } }
    end
  ...
  test "should update exam" do
    patch exam_url(@exam), params: { exam: { consideration: @exam.consideration, name: @exam.name, passed_at: @exam.passed_at } }
